...
namespace Movieasy.Infrastructure.Caching
{
    internal sealed class CacheService : ICacheService
    {
        ...
        {
            return JsonSerializer.Deserialize<T>(bytes)!; // Null forgiving is used because im certain the data will come around valid
        }
